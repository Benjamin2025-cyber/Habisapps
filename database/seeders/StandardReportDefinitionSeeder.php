    ...
    private static function seedData(): array
    {
        return [
            [
                ...
                'module' => 'accounting',
                'description' => 'Standard trial balance report showing ledger account balances for a given agency and currency. Pass consolidated=true to roll agency detail accounts up into their institution grouping accounts.',
                'supported_parameters' => ['agency', 'currency', 'consolidated'],
