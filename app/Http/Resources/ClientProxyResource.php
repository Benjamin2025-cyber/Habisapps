...
final class ClientProxyResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'proxy_first_name' => $showPii ? $record->proxy_first_name : $this->maskName($record->proxy_first_name),
            'proxy_last_name' => $showPii ? $record->proxy_last_name : $this->maskName($record->proxy_last_name),
            'proxy_middle_name' => $showPii ? $record->proxy_middle_name : $this->maskName($record->proxy_middle_name),
            'proxy_father_name' => $showPii ? $record->proxy_father_name : $this->maskName($record->proxy_father_name),
            'proxy_mother_name' => $showPii ? $record->proxy_mother_name : $this->maskName($record->proxy_mother_name),
            'proxy_date_of_birth' => $showPii ? $this->formatDate($record->proxy_date_of_birth) : null,
            'proxy_place_of_birth' => $showPii ? $record->proxy_place_of_birth : null,
            'proxy_identity_issued_on' => $showPii ? $this->formatDate($record->proxy_identity_issued_on) : null,
            'proxy_identity_issued_at' => $showPii ? $record->proxy_identity_issued_at : null,
            'proxy_address_line_1' => $showPii ? $record->proxy_address_line_1 : null,
            'proxy_address_line_2' => $showPii ? $record->proxy_address_line_2 : null,
            'proxy_business_address_line_1' => $showPii ? $record->proxy_business_address_line_1 : null,
            'proxy_business_address_line_2' => $showPii ? $record->proxy_business_address_line_2 : null,
