...
final class TellerSessionResource extends JsonResource
{
     ...
     *     manual_journal_cash_movement_minor: int,
     *     reversals_total_minor: int,
     *     commissions_total_minor: int,
     *     distinct_clients_served_count: int,
    ...
    private function summaryPayload(mixed $summary): ?array
    {
        ...
        return [
            ...
            'manual_journal_cash_movement_minor' => $this->summaryInt($summary, 'manual_journal_cash_movement_minor'),
            'reversals_total_minor' => $this->summaryInt($summary, 'reversals_total_minor'),
            'commissions_total_minor' => $this->summaryInt($summary, 'commissions_total_minor'),
            'distinct_clients_served_count' => $this->summaryInt($summary, 'distinct_clients_served_count'),
