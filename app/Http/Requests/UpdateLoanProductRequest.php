...
final class UpdateLoanProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'penalty_formula_type' => ['sometimes', 'nullable', 'string', 'max:64'],
            'penalty_formula_base' => ['sometimes', 'nullable', 'string', 'max:64'],
            'penalty_value_type' => ['sometimes', 'nullable', 'string', 'max:32'],
